...
**Status:** Historical migration/reference doc (original Phase 5B of UI migration prep). Not authoritative for new work.
...
1. `LabAssistant/Views/TemplatesPage.xaml.cs`
2. `LabAssistant/Views/TemplateEditorPage.xaml.cs`
3. `docs/02-ux/Archived/current-ui-capability-audit.md` (Templates fragmentation section)
...
3. `docs/03-architecture/Archived/gui-action-map.settings-diagnostics-shell.md`

### "Why is Logs page not the same thing as Diagnostics?"
Read:
1. `LabAssistant/Views/LogsPage.xaml.cs`
2. `LabAssistant/ViewModels/DeploymentViewModel.cs`
3. `docs/02-ux/Archived/current-ui-capability-audit.md` (Diagnostics section)
