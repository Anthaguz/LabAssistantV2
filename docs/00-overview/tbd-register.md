...
| TBD-038 | Whether to formalize PowerShell wrapper protocol and lifecycle details in a dedicated supportability doc | `docs/03-architecture/architecture.md` | Backlog | Revisit when wrapper tracing, supportability, or wrapper redesign work is scoped. |
