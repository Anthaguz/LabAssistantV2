...
**Status:** Approved implementation contract for the `Assets Switches` post-AM43 cleanup sequence.
...
- `docs/02-ux/winui-assets-workspace-extraction-seam-am.md`
- `docs/02-ux/winui-assets-composition-cleanup-target-am.md`
- `docs/02-ux/winui-assets-overview-extraction-cleanup-target-am.md`
- `docs/02-ux/winui-assets-base-disks-extraction-cleanup-target-am.md`
