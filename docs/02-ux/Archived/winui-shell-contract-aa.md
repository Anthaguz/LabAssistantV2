...
Note: Milestone AC introduces the global `NavigationView` convergence contract for hierarchical entity/action routing. AA navigation rules remain valid unless superseded by `docs/02-ux/Archived/winui-global-navigationview-contract-ac.md`.
