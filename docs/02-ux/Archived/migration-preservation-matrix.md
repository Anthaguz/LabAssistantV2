...
- **Reference:** `docs/03-architecture/Archived/gui-action-map.deploy.md`
...
- **Reference:** `docs/03-architecture/Archived/gui-action-map.templates.md`
...
- **Reference:** `docs/03-architecture/Archived/gui-action-map.assets.md`
...
- **Reference:** `docs/03-architecture/Archived/gui-action-map.settings-diagnostics-shell.md`
