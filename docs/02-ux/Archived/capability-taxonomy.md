...
- `docs/02-ux/Archived/ui-inventory.md`
- `docs/02-ux/Archived/user-flows.md`
...
Detailed navigation behavior is defined in `docs/02-ux/Archived/navigation-ia-draft.md`.
