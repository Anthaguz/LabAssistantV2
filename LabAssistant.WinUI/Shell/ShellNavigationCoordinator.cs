...
internal sealed class ShellNavigationCoordinator
{
    ...
    private readonly Func<Task> _ensureMachinesInventoryAsync;
    ...
    public ShellNavigationCoordinator(
        ...
        Func<Task> ensureMachinesInventoryAsync)
    {
        ...
        _ensureMachinesInventoryAsync = ensureMachinesInventoryAsync;
